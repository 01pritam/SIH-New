      ...
      {authToken ? (
        <div className="contest-form">
          ...
          <div className="todo-list">
            ...
            <button onClick={submitContestData}>Submit Forge</button> {/* Attach the submitContestData function */}
          </div>
        </div>
      ) : (
        <p>Please login to create a forge.</p>
      )}

      {/* List of submitted contests */}
      <h2>Submitted Forge</h2>
